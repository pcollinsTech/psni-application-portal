    ...
    'panels' => [
        [
            ...
            'fields' => function (NovaRequest $request) {
                return [
                    DateTime::make('Registration Opening Date', 'opening_date'),
                    DateTime::make('Registration Closing Date', 'closing_date'),

                    Date::make('Placement Start Date', 'placement_start_date'),
                ];
            }
        ],
//        [
